...
async def predictRouteClient(request: Request):
    ...
    try:
        ...
        try:
            ...
            error_message = f"Prediction warning: {prediction_error}"
            value = None

        if value is None:
            status = "Visa-approved" if form.prevailing_wage and int(form.prevailing_wage) < 50000 else "Visa Not-Approved"
        elif value == 1:
